...
void saveGame(int** board, int** solution, int boardN, int k, int level, int mistakes, int seconds) {
...
int loadGame(int*** board, int*** solution, int* boardN, int* k, int* level, int* mistakes, int* seconds) {
